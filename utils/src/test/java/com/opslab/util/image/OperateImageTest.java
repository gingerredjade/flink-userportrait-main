...
public class OperateImageTest extends TestCase {
    ...
    public void testJoinImagesHorizontal() {
    ...
    public void testJoinImageListHorizontal() {
    ...
    public void testJoinImagesVertical() {
        String file1 = path + "1.jpg";
        String file2 = path + "2.jpg";
    ...
    public void testMergeBothImageTopleftcorner() {

    }

    public void testMergeBothImageToprightcorner() {

    }

    public void testMergeBothImageLeftbottom() {

    }

    public void testMergeBothImageRightbottom() {

    }

    public void testMergeBothImageCenter() {

    }

    public void testMergeBothImageTopcenter() {

    }

    public void testMergeBothImageBottomcenter() {

    }

    public void testMergeBothImageLeftcenter() {

    }

    public void testMergeBothImageRightcenter() {
    ...
    public void testAlphaImage2Image() {
    ...
    public void testDrawPolylineShowPoints() {
    ...
    public void testDrawAndAlphaPolygon() {
